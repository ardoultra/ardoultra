...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0a0b10,50:7c3aed,100:22d3ee&height=220&section=header&text=Guillermo%20Rivera&fontSize=42&fontColor=ffffff&fontAlignY=35&desc=Software%20Engineering%20Student%20%7C%20Fullstack%20Developer%20in%20Progress&descSize=14&descColor=94a3b8&descAlignY=55"/>

</div>

### Sobre mi

Estudiante de Ingenieria en Tecnologia de Software en la Facultad de Ingenieria Mecanica y Electrica (FIME), Nuevo Leon, Mexico. Enfocado en desarrollo fullstack con el stack de JavaScript/TypeScript. Actualmente construyendo proyectos y preparandome para practicas profesionales.
...
| Mas proyectos en camino... | Blackjack, TodoApp, CRUD App, Dashboard React, API REST, App movil | JS, React, Node, Nest, Docker |
